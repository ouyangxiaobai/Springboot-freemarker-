    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>编辑维修工</h4></div>
              <div class="card-body">
                <form action="add" id="emp-add-form" method="post" class="row">
                        ...
                        <div class="form-controls">
                            <ul class="list-inline clearfix lyear-uploads-pic">
                                <li class="col-xs-4 col-sm-3 col-md-2">
                                    <figure>
                            <#if emp.headPic?length gt 0>
                                <img src="/photo/view?filename=${emp.headPic}" id="show-picture-img">
                            <#else>
                    		<img src="/admin/images/default-head.jpg" id="show-picture-img" alt="默认头像">
                            </#if>
                                    </figure>
                                </li>
                                <input type="hidden" name="headPic" id="headPic" value="${emp.headPic}">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="${emp.name}" placeholder="请输入员工姓名" tips="请填写姓名" />
                  </div>
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">手机号码</span>
                    <input type="tel" class="form-control" id="mobile" name="mobile" value="${emp.mobile}" />
                  </div>
                  <div class="input-group m-b-10">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <select name="building.id" class="form-control" id="buiding">
                      <#list buidings as b>
                        <option value="${b.id}"<#if emp.building.bno == b.bno>selected</#if> >${b.campus}${b.bno}号楼</option>
                      </#list>
                    </select>
                  </div>
                  <div class="input-group m-b-10">
                    ...
                    <select name="empType" class="form-control" id="emptype">
                     <#list empTypes as empType>
                      <option value="${empType}" <#if emp.empType == empType>selected</#if>  >${empType.getName()}</option>
                      </#list>
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <label class="lyear-radio radio-inline radio-primary" style="margin-left:30px;">
                      <input type="radio" name="sex" value="1"  <#if emp.sex == 1> checked </#if> >
                      <span>男</span>
                      <label class="lyear-radio radio-inline radio-primary">
                        <input type="radio" name="sex" value="2"  <#if emp.sex == 2> checked </#if>>
                        <span>女</span>
                        <label class="lyear-radio radio-inline radio-primary">
                          <input type="radio" name="sex" value="0"  <#if emp.sex == 0> checked </#if>>
                          <span>未知</span>
                        </label>
                  </div>
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('维修工修改成功!',function(){
