...
<body  style="background:url('/admin/images/login-bg.jpg') no-repeat; background-size: cover;">
    ...
    <div class="login-center">
      ...
      <form id="login-form" method="post">
          <div class="input-group m-b-10">
              <span class="input-group-addon">请选择登陆</span>
              <select name="counsellorId.id" class="form-control" id="type">
                  <option value="0">学生登陆</option>
                  <option value="1">维修工登陆</option>
...
$(document).ready(function(){
	$("#submit-btn").click(function(){
      ...
      if(username.indexOf("E") != -1 && type != 1 ) {
        showErrorMsg("请选择维修工进行登录");
        return;
      }else  if(username.indexOf("S") != -1 && type != 0 ) {
        showErrorMsg("请选择学生进行登录");
        return;
      }
