              ...
              <div class="card-body">
                  <form action="add" id="student-add-form" method="post" class="row">
                      ...
                      <div class="input-group m-b-10">
                          ...
                          <input type="tel" class="form-control required" id="name" name="studentName" value="${student.studentName!""}"  placeholder="请输入学生名称" tips="请填写学生名称"/>
                      </div>
                      ...
                      <div class="input-group" style="margin-top:15px;margin-bottom:15px;padding-left:25px;">
                          ...
                          <label class="lyear-radio radio-inline radio-primary" style="margin-left:30px;">
                              <input type="radio" name="studentSex" value="0"
                      ...
                      <div class="input-group m-b-10">
                          ...
                          <input type="tel" class="form-control  required" id="email" name="email" value="${student.email!""}"  placeholder="请输入邮箱地址" tips="请填写邮箱地址"/>
                      </div>
                      <div class="input-group m-b-10">
                          <span class="input-group-addon">联系方式</span>
                          <input type="tel" class="form-control  required" id="mobile" name="mobile" value="${student.mobile!""}"  placeholder="请输入联系方式" tips="请填写联系方式"/>
                      </div>
                      <div class="input-group m-b-10">
                     ...
                     <#list coachs as coach>
                         <option value="${coach.id}"
                                 <#if coach.id==student.counsellorId.id >
                                     selected="selected"
                                 </#if>
                         >${coach.name}</option>
                     </#list>
                     ...
                     <#list buildings as building>
                         <option value="${building.id}"
                                 <#if building.id=student.dormitory.building.id > selected="selected"</#if>
                     ...
                     <#list dormitorys as dormitory>
                         <option value="${dormitory.id}"
                                 <#if dormitory.id==student.dormitory.id >
                                     selected="selected"
                                 </#if>
